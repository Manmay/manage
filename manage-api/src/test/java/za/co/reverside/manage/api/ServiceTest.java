...
//        GoogleToken tokenRequest = new GoogleToken();
...
//        GoogleToken tokenResponse = restTemplate.postForObject("https://www.googleapis.com/oauth2/v3/token", tokenRequest, GoogleToken.class);
