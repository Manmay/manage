define(['jquery', 'hammer', 'bootstrap', 'setup', 'resize-text', 'bar-chart', 'donut-chart', 'progress-chart', 'jquery-color', 'portfolio', 'ticker', 'google-maps', 'contact', 'css-book', 'colorbox', 'demo', 'colpick'], function($, Hammer) {
	$(function() {
